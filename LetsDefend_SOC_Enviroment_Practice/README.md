...
|------|----------|------------|---------------|
| ⭐ SharePoint ToolShell Auth Bypass & RCE | Critical | PowerShell, CVE Analysis, Web Logs | [--> View](./LetsDefend_SOC_Environment_Practice/Use_case_011_SharePoint_ToolShell_Auth_Bypass_RCE/README.md) |
