...
The suspicious domain letsdefwnd[.]io closely resembles the legitimate LetsDefend domain and was configured with a new mail exchange (MX) record:
...
Source Email	no-reply@cti-report.io
Destination Email	soc@letsdefend.io
...
The attacker replaced the letter:

m → w

creating a visually similar domain likely intended to deceive users.
